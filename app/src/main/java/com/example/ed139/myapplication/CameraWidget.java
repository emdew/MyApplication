...
public class CameraWidget extends AppWidgetProvider {
    ...
    void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        // Create Intent and wrap in PendingIntent
        Intent takePictureIntent = new Intent(context, EditorActivity.class);
        takePictureIntent.putExtra("Flag", "widget");
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, takePictureIntent, 0);

        // set PendingIntent on RemoteView
